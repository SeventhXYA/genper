...
<head>
    <title>GenPermata Password Reset</title>
...
<body
    ...
    <h1 style="margin-bottom: 30px">
        <a href="{{ env('APP_URL') }}" style="text-decoration: none">
            <span style="color: #000865">Gen</span><span style="color: #05a34a; font-weight: 300">Permata</span>
        </a>
    </h1>
    ...
    <div
        ...
        <div style="font-size: 0.9em">Gen Permata</div>
    </div>
