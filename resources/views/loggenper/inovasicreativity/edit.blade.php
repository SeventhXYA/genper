            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form onsubmit="$('#submit').prop('disabled',true)"
                        action="/inovasicreativity/update/{{ $dailyic->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group date" id="datePickerExample">
                                    <input type="text" class="form-control"name="tgl_ic" value="{{ $dailyic->tgl_ic }}"
                                        id="defaultconfig-0">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group date timepicker" id="datetimepickerExample"
                                    ...
                                    <input type="text" class="form-control datetimepicker-input" name="wkt_mulai"
                                        value="{{ $dailyic->wkt_mulai }}" data-target="#datetimepickerExample" />
                            ...
                            <div class="col-lg-3">
                                <div class="input-group date timepicker" id="datetimepickerExample2"
                                    ...
                                    <input type="text" class="form-control datetimepicker-input"
                                        name="wkt_selesai"value="{{ $dailyic->wkt_selesai }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig" maxlength="500" rows="8" name="rencana"
                                    placeholder="This textarea has a limit of 500 chars.">{{ $dailyic->rencana }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="500" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 500 chars.">{{ $dailyic->aktual }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <div class="container">
                                    <input type="range" id="my-slider" min="0" max="100"
                                        value="{{ $dailyic->progres }}" name="progres" oninput="slider()">
                                    <div id="slider-value">{{ $dailyic->progres }}</div>
                                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <div id="preview" class="my-3"
                                        style="aspect-ratio: 4/3; background-image: url({{ asset($dailyic->foto) }});background-color:rgb(196, 196, 196);background-size: cover;scroll-snap-align: center;">
                                    </div>
                                </div>
                            </div>
                        </div>
