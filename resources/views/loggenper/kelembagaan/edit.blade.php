        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/kelembagaan/update/{{ $dailykl->id }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig" maxlength="500" rows="8" name="rencana"
                                    placeholder="This textarea has a limit of 500 chars.">{{ $dailykl->rencana }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="500" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 500 chars.">{{ $dailykl->aktual }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <div id="preview" class="my-3"
                                        style="aspect-ratio: 4/3; background-image: url({{ asset($dailykl->foto) }});background-color:rgb(196, 196, 196);background-size: cover;scroll-snap-align: center;">
                                    </div>
                                </div>
                            </div>
                        </div>
