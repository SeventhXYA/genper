        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form onsubmit="$('#submit').prop('disabled',true)" action="{{ route('newbp.store') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group date" id="datePickerExample">
                                    <input type="text" class="form-control"name="tgl_bp" id="defaultconfig-0">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="500" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 500 chars."></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
