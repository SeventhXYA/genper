...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Bisnis & Profit</a></li>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group date" id="datePickerExample">
                                    <input type="text" class="form-control"name="tgl_bp" value="{{ $dailybp->tgl_bp }}"
                                        id="defaultconfig-0">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group date timepicker" id="datetimepickerExample"
                                    ...
                                    <input type="text" class="form-control datetimepicker-input" name="wkt_mulai"
                                        value="{{ $dailybp->wkt_mulai }}" data-target="#datetimepickerExample" />
                            ...
                            <div class="col-lg-3">
                                <div class="input-group date timepicker" id="datetimepickerExample2"
                                    ...
                                    <input type="text" class="form-control datetimepicker-input"
                                        name="wkt_selesai"value="{{ $dailybp->wkt_selesai }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig" maxlength="500" rows="8" name="rencana"
                                    placeholder="This textarea has a limit of 500 chars.">{{ $dailybp->rencana }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="500" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 500 chars.">{{ $dailybp->aktual }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <div class="container">
                                    <input type="range" id="my-slider" min="0" max="100"
                                        value="{{ $dailybp->progres }}" name="progres" oninput="slider()">
                                    <div id="slider-value">{{ $dailybp->progres }}</div>
                                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <div id="preview" class="my-3"
                                        style="aspect-ratio: 4/3; background-image: url({{ asset($dailybp->foto) }});background-color:rgb(196, 196, 196);background-size: cover;scroll-snap-align: center;">
                                    </div>
                                </div>
                            </div>
                        </div>
