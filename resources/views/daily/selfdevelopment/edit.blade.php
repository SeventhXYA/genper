            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- <p class="text-muted mb-3">Read the <a href="https://github.com/mimo84/bootstrap-maxlength"
                        ...
                        and other options.</p> --}}
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/historysd/update/{{ $dailysd->id }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig" maxlength="100" rows="8" name="rencana"
                                    placeholder="This textarea has a limit of 100 chars.">{{ $dailysd->rencana }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="100" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 100 chars.">{{ $dailysd->aktual }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
