                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea" class="form-control" id="defaultconfig" maxlength="100" rows="8" name="rencana"
                                    placeholder="This textarea has a limit of 100 chars.">{{ $dailybp->rencana }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                                <textarea id="maxlength-textarea-2" class="form-control" id="defaultconfig" maxlength="100" rows="8"
                                    name="aktual" placeholder="This textarea has a limit of 100 chars.">{{ $dailybp->aktual }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
