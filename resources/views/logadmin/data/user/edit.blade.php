...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)" action="/user/update/{{ $user->id }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 inline">
                                <select class="form-select" id="exampleFormControlSelect1" name="jk" style="width: 30%"
                                    required>
                                    <option selected value="{{ $user->jk }}" readonly>{{ $user->jk }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 inline">
                                <input class="form-control me-2" maxlength="255" name="tgl_lahir" type="date"
                                    autocomplete="off" style="width: 30%" required value="{{ $user->tgl_lahir }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 inline">
                                <select class="js-example-basic-single form-select" name="id_divisi" data-width="60%">
                                    <option value="" {{ is_null($user->id_divisi) ? 'selected' : '' }}>Pilih Divisi
                                    </option>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-lg-9 inline">
                                <select class="form-select" id="exampleFormControlSelect1" name="id_level"
                                    ...
                                    <option selected value="{{ $user->id_level }}" readonly>{{ $user->level->level }}
                                    </option>
                                    @foreach ($level as $lv)
                                        @if ($lv->id !== 2)
