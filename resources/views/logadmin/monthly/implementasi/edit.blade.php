            ...
            <div class="card">
                <div class="card-body">
                    <form onsubmit="$('#submit').prop('disabled',true)"
                        action="/implementasi/update/{{ $implementasi->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8 inline">
                                <select class="js-example-basic-single form-select" name="start_date" data-width="40%"
                                    required>
                                    <option selected disabled readonly>{{ $implementasi->start_date }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-8 d-flex inline">
                                ...
                                <input class="form-control" maxlength="255" name="pelaksana" style="width: 50%;"
                                    id="defaultconfig-text" type="text" value="{{ $implementasi->pelaksana }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-2 ">
                                <select class="form-select" id="exampleFormControlSelect1" name="keterangan">
                                    <option selected disabled>{{ $implementasi->keterangan }}</option>
